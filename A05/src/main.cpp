...
class A05 : public BaseProject {
	...
	void localInit() {
		...
		// Models, textures and Descriptors (values assigned to the uniforms)
		M1.init(this, "assets/models/Character.obj");
		MG.init(this, "assets/models/floor.obj");
		
		T1.init(this, "assets/textures/Colors2.png");
		TG[0].init(this, "assets/textures/u5chunkedMap-0.png");
		TG[1].init(this, "assets/textures/u5chunkedMap-1.png");
		TG[2].init(this, "assets/textures/u5chunkedMap-2.png");
		TG[3].init(this, "assets/textures/u5chunkedMap-3.png");
